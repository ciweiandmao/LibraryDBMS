...
public class ManagerModify extends JFrame {

    public ManagerModify() throws SQLException {
        ...
        JLabel NDV1 = new JLabel("工作号");
        JLabel NDV2 = new JLabel("姓名");
        JLabel NDV3 = new JLabel("年龄");
        JLabel NDV4 = new JLabel("工作");
        JLabel NDV5 = new JLabel("工资");
        JLabel NDV6 = new JLabel("入职日期");
        ...
        NDV11.setText("MAN" + Windows.GetCode());
        NDV11.setEditable(false);
        NDV16.setText(Windows.GetTime(0));

        if (Windows.isChanging) {
            ResultSet Data = Windows.SearchSingle("select * from manager where MANID ='" + Windows.MyData + "'");
            Data.next();
            NDV11.setText(Data.getString("MANID"));
            NDV12.setText(Data.getString("Name"));
            NDV13.setText(Data.getString("Age"));
            NDV14.setText(Data.getString("Work"));
            NDV15.setText(Data.getString("Salary"));
            NDV16.setText(Data.getString("HireDate"));
        }
        ...
        NDV10.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JFrame MAN = new CommonTable();
                MAN.setTitle("管理员管理");
                MAN.setSize(1000, 800);
                MAN.setLocation(300, 100);
                MAN.setResizable(false);
                MAN.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                MAN.setVisible(true);
                ManagerModify.this.dispose();}
        ...
        NDV9.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (Windows.isChanging) {
                    Windows.ChangeData("UPDATE manager SET  Name = '"+NDV12.getText()+"', Age = '"+NDV13.getText()+"', " +
                            "Work = '"+NDV14.getText()+"', Salary = '"+NDV15.getText()+"', HireDate = '"+NDV16.getText()+"' WHERE MANID = '"+Windows.MyData+"'");
                } else {
                    Windows.AddNewData("INSERT INTO manager (MANID,Name,Age,Work,Salary,HireDate) VALUES ('"
                            + NDV11.getText() + "', '" + NDV12.getText() + "','" + NDV13.getText() + "','" + NDV14.getText() + "','" + NDV15.getText() + "','" + NDV16.getText() + "')");
                }
                NDV10.doClick();
            }
